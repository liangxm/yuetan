...
array (
  ...
  array (
    ...
    array (
      ...
      'includes'=> array(
	array('file'=>'custom/modules/lxm1_lxm_residents1/residents.js'),
      ),
      'useTabs' => false,
      'tabDefs' => 
      array (
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'id_number',
            'label' => 'LBL_ID_NUMBER',
            'customCode' => '<input name="id_number" id="id_number" size="30" maxlength="30" type="text" value="{$fields.id_number.value}">',
          ),
          1 => 
          array (
            'name' => 'work_unit',
            'label' => 'LBL_WORK_UNIT',
            'customCode' => '<input name="work_unit" id="work_unit" size="30" maxlength="30" type="text" value="{$fields.work_unit.value}">',
          ),
        ),
        5 => 
        array (
	    ...
	    'customCode' => '<input name="residences_address" id="residences_address" size="30" type="text" value="{$fields.residences_address.value}">',
          ),
        ),
        6 => 
        array (
	    ...
	    'customCode' => '<input name="persent_address" id="persent_address" size="30" type="text" value="{$fields.persent_address.value}">',
          ),
        ),
        7 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input name="belong_street" id="belong_street" size="30" type="text" value="{$fields.belong_street.value}">',
          ),
        ),
        8 => 
        array (
	    ...
	    'customCode' => '<textarea id="personal_details" name="personal_details" rows="4" cols="160" title="请输入150以内的字符" maxlength="150" tabindex="0"></textarea>',
          ),
        ),
        9 => 
        array (
	    ...
	    'customCode' => '<textarea id="disease_situation" name="disease_situation" rows="4" cols="160" title="请输入150以内的字符" maxlength="150" tabindex="0"></textarea>',
          ),
        ),
        10 => 
        array (
          ...
          array (
            ...
            'customCode' => '<textarea id="pocketbook" name="pocketbook" rows="4" cols="160" title="请输入150以内的字符" maxlength="150" tabindex="0"></textarea>',
          ),
        ),
      ),
      'lbl_editview_panel2' => 
      array (
	    ...
	    'customCode' => '<textarea id="primary_issue" name="primary_issue" rows="4" cols="160" title="请输入150以内的字符" maxlength="150" tabindex="0"></textarea>',
          ),
        ),
        1 => 
        array (
          ...
          array (
            ...
            'customCode' => '<input name="issue_type" id="issue_type" size="30" maxlength="30" type="text" value="{$fields.issue_type.value}">',
          ),
          1 => 
          array (
            'name' => 'event_place',
	    ...
	    'customCode' => '<textarea id="residents_situation" name="residents_situation" rows="4" cols="160" title="请输入150以内的字符" maxlength="150" tabindex="0"></textarea>',
          ),
        ),
        4 => 
        array (
        ...
        array (
          ...
          array (
            ...
            'customCode' => '<input name="responsibility_phone" id="responsibility_phone" size="30" maxlength="30" type="text" value="{$fields.responsibility_phone.value}">',
          ),
        ),
        6 => 
        array (
