<?php
$app_strings['LBL_GROUPTAB5_1411918062'] = '首页';

$GLOBALS['app_list_strings']['user_type_dom']=array (
  'RegularUser' => '用户账号',
  'Administrator' => '系统管理员账号',
);
$app_list_strings['moduleList']['lxm1_lxm_conversation']='约谈记录';
$app_list_strings['moduleListSingular']['lxm1_lxm_conversation']='约谈记录';

$GLOBALS['app_list_strings']['relationship_list']=array (
  'spouse' => '配偶',
  'father_daughter' => '父女',
  'mother_son' => '母子',
  'mother_daughter' => '母女',
