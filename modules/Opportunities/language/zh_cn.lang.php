...
//END DON'T CONVERT
  ...
  //For export labels
    ...
    'LBL_OPPORTUNITY_TYPE' => '商业机会 类型',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '指派的用户名',
    'LBL_EXPORT_ASSIGNED_USER_ID' => '指派的用户 ID',
    'LBL_EXPORT_MODIFIED_USER_ID' => '修改者 ID',
    'LBL_EXPORT_CREATED_BY' => '创建者 ID',
    'LBL_EXPORT_NAME'=>'名称',

  // SNIP
  'LBL_CONTACT_HISTORY_SUBPANEL_TITLE' => '关联到 联系人\' Emails',
);
