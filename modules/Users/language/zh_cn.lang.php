...
$mod_strings = array (
    'LBL_DELETE_USER_CONFIRM'           => '当用户记录被删除，相应的员工记录也将被删除。 用户被删除后，任何与此用户相关的工作流的定义和报可能需要更新。<br/><br/>'.
                                                '删除的用户记录将不能撤销。',
...
'LBL_PASSWORD_SENT' => '密码已经更新',
  ...
  'LBL_SUBPANEL_LINKS_DESCRIPTION' => '在细节试图中，显示一行面板的快速链接。',
  'LBL_SUBPANEL_TABS' => '面板标签',
   'LBL_SUBPANEL_TABS_DESCRIPTION' => '在细节试图中，把面板分组到标签中，并且一次显示一个标签。',
...
// PROJECT RESOURCES STRINGS
  ...
  'LBL_WIZARD_FINISH_TITLE' => '您已经装备好了使用Sugar!',
    ...
    'LBL_WIZARD_FINISH' => '点击下面的 <b>结束</b> 保存您的设置并且开始使用Sugar。更多关于使用Sugar的信息:<br /><br />
...
<tr><td><!--not_in_theme!--><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/university" target="_blank"><b>Sugar University</b></a><br>End-user and System Administrator Training and Resources</td></tr>
  ...
  'LBL_WIZARD_SMTP_DESC' => '为默认的发送电子邮件服务器提供您的账号和密码。',
    ...
    'LBL_DELETED' => '已删除',
    'LBL_HIDEOPTIONS' => '隐藏设置',
    'LBL_SHOWOPTIONS' => '显示设置',
