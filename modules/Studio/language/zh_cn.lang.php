...
'LBL_CONFIGURE_GROUP_TABS' => '设置组模块',
 //end bug #15095 fix
'LBL_GROUP_TAB_WELCOME'=>'用户选择显示的分组模块将会在导航栏中出现。从分组中拖拽模块，可使此模块显示在该分组下。提示：导航栏里不会显示空白分组；分组可拖拽改变位置。',
'LBL_RENAME_TAB_WELCOME'=>'在下表种，点击任一标签的显示值，可更改此分组的标签名称。',
'LBL_DELETE_MODULE'=>'从&nbsp;分组内 删除&nbsp;模块<br />',
'LBL_DISPLAY_OTHER_TAB_HELP' => '在导航栏里选择显示”其他选项“的标签。  默认, ”其他选项“的标签在没有包含在其他组的任何模块里显示。',
'LBL_TAB_GROUP_LANGUAGE_HELP' => '选择一种有效的语言，编辑分组标签，并且在已选语言里点击"保存&部署"应用标签。',
'LBL_ADD_GROUP'=>'增加分组',
'LBL_NEW_GROUP'=>'新建分组',
'LBL_RENAME_TABS'=>'重命名标签',
'LBL_DISPLAY_OTHER_TAB' => '显示 \'其他选项\' 标签',
...
'LBL_SP_PREVIEW'=>'在此处您可以预览您的样式表。',
	...
	'LBL_REDO' => '再做一次' /*for 508 compliance fix*/,
	'LBL_INLINE' => '直列' /*for 508 compliance fix*/,
	'LBL_DELETE' => '删除' /*for 508 compliance fix*/,
	'LBL_ADD_FIELD' => '新增文件夹' /*for 508 compliance fix*/,
	'LBL_MAXIMIZE' => '最大化' /*for 508 compliance fix*/,
	'LBL_MINIMIZE' => '最大化' /*for 508 compliance fix*/,
	'LBL_PUBLISH' => '出版' /*for 508 compliance fix*/,
...
'LBL_SINGULAR' => '单个标签',
'LBL_PLURAL' => '多个标签',
'LBL_RENAME_MOD_SAVE_HELP' => '单击 <b>保存</b> 使变化生效。'
