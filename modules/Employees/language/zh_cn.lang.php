...
$mod_strings = array (
  ...
  'LBL_ONLY_ACTIVE' => '在职员工',
  'LBL_SELECT' => '选择' /*for 508 compliance fix*/,
  'LBL_FF_CLEAR' => '清除' /*for 508 compliance fix*/,
  'LBL_AUTHENTICATE_ID' => '正确的ID',
  'LBL_EXT_AUTHENTICATE' => '外部认证',
  'LBL_GROUP_USER' => '用户组',
  'LBL_LIST_ACCEPT_STATUS' => '接受状态',
  'LBL_MODIFIED_BY' =>'修改者',
  'LBL_MODIFIED_BY_ID' =>'修改者Id',
  'LBL_CREATED_BY_NAME' => '创建者', //bug48978
  'LBL_PORTAL_ONLY_USER' => 'Portal API用户',
  'LBL_PSW_MODIFIED' => '您已经更改了您的密码',
  'LBL_SHOW_ON_EMPLOYEES' => '显示记录',
  'LBL_USER_HASH' => '密码',
