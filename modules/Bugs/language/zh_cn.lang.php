...
$mod_strings = array (
  ...
  'LBL_LIST_ASSIGNED_TO_NAME' => '指定使用者',
    ...
    //For export labels
	'LBL_FOUND_IN_RELEASE_NAME' => '发现发布名称',
    'LBL_PORTAL_VIEWABLE' => '网站浏览',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '分配用户',
    'LBL_EXPORT_ASSIGNED_USER_ID' => '分配用户ID',
    'LBL_EXPORT_FIXED_IN_RELEASE_NAMR' => '固定发布名称',
