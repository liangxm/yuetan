 ...
 * PLACE ANY CUSTOMIZATIONS IN lxm_report
 */


class lxm_report_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'lxm_report';
	var $object_name = 'lxm_report';
	var $table_name = 'lxm_report';
