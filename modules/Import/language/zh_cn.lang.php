...
$mod_strings = array (
    ...
    'LBL_ERROR_SYNC_USERS' => '无效的同步到Outlook: ',
    ...
    'LBL_TAB' => '制表符分隔符文件',
    'LBL_CUSTOM_DELIMITED' => '自定义分隔符文件',
    'LBL_CUSTOM_DELIMITER' => '字段定界符:',
    'LBL_FILE_OPTIONS' => '文件选项',
    'LBL_CUSTOM_TAB' => '自定义制表符分隔符文件',
    'LBL_DONT_MAP' => '-- 不要对应这个字段 --',
    'LBL_STEP_MODULE' => '你想导入数据到哪个模块中？',
    'LBL_STEP_1_TITLE' => '第一步:选择来源',
    'LBL_CONFIRM_TITLE' => '步骤 {0}: 确定导入文件属性',
    'LBL_CONFIRM_EXT_TITLE' => '步骤 {0}: 确定外部数据源属性',
    'LBL_WHAT_IS' => '来源是什么?',
    ...
    'LBL_DATABASE_FIELD_HELP' => '从模块的数据库表中选择一个存在字段。',
	...
	'LBL_THIRD_PARTY_CSV_SOURCES' => '选择其中一个来源，在文件数据导出时.',
    'LBL_THIRD_PARTY_CSV_SOURCES_HELP' => '为简化映射过程，选择自动应用自定义映射(下一步).',
    'LBL_EXTERNAL_SOURCE_HELP' => '使用这个选项，直接从外部应用程序或服务输入数据, 例如Gmail.',
    'LBL_EXAMPLE_FILE' => '下载文件导入模板',
    ...
    'LBL_SELECT_UPLOAD_INSTRUCTION' => '在你的电脑上选择一个你想导入的数据文件，或者下载一个模版来创建导入文件。',
