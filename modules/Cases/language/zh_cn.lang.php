...
$mod_strings = array (
    ...
    'LBL_CASE_INFORMATION' => '预览',

    //For export labels
    'LBL_MODIFIED_BY_NAME_OWNER' => '使用所有者的名称修改',
    'LBL_MODIFIED_BY_NAME_MOD' => '使用模块的名称修改',
    'LBL_CREATED_BY_NAME_OWNER' => '使用所有者的名称创建',
    'LBL_CREATED_BY_NAME_MOD' => '使用模块的名称创建',
    'LBL_ASSIGNED_USER_NAME_OWNER' => '指派所有者的名称',
    'LBL_ASSIGNED_USER_NAME_MOD' => '指派模块的名称',
    'LBL_TEAM_COUNT_OWNER' => '所有者的团队数量',
    'LBL_TEAM_COUNT_MOD' => '团队数量模块',
    ...
    'LBL_EXPORT_MODIFIED_USER_ID' => '使用ID修改',
    'LBL_EXPORT_CREATED_BY' => '使用ID创建',
    'LBL_EXPORT_CREATED_BY_NAME' => '使用用户名称创建',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '指派用户名称',
    'LBL_EXPORT_TEAM_COUNT' => '团队数量',

    // SNIP
	'LBL_CONTACT_HISTORY_SUBPANEL_TITLE' => '关联到 联系人的 Emails',
);
