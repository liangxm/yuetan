...
//       it is the key for the default record_type_module value
 ...
 'case_type_dom' =>
  ...
  array (
    ...
    'dom_email_link_type'   => array(   'sugar'     => 'SugarCRM邮件客户端',
                                        'mailto'    => '外部邮件客户端'),
...
$app_strings = array (
  ...
  'LBL_EDIT_INLINE' => '在线编辑' /*for 508 compliance fix*/,
  'LBL_VIEW_INLINE' => '视图' /*for 508 compliance fix*/,
  'LBL_BASIC_SEARCH' => '搜索' /*for 508 compliance fix*/,
  'LBL_PROJECT_MINUS' => '移动' /*for 508 compliance fix*/,
  ...
  'LBL_MOREDETAIL' => '更多细节' /*for 508 compliance fix*/,
    ...
    'LBL_VIEWINLINE'=>'视图',
    'LBL_INFOINLINE'=>'消息',
    'LBL_POWERED_BY_SUGARCRM' => "由SugarCRM驱动",
    'LBL_PRINT' => "打印",
    'LBL_HELP' => "帮助",
    'LBL_ID_FF_SELECT' => "选择",
    'DEFAULT'                              => '普通',
    ...
    'LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS'     => '设置邮件缺省值 Gmail&#153; ',
    'LBL_EMAIL_ACCOUNTS_NAME'               => '成成',
    ...
    'LBL_EMAIL_DELIMITER'                   => '::;::',
    'LBL_EMAIL_DOWNLOAD_STATUS'             => '下载 [[数量]]  [[总共]] 邮件',
    'LBL_EMAIL_FOUND'                       => '发现',
    'LBL_EMAIL_FROM'                        => '从',
    'LBL_EMAIL_GROUP'                       => '组',
	...
	'LBL_SMTPTYPE_EXCHANGE'                 => '微软 Exchange',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT'    => '邮件模板的纯文本为空',
    ...
    'ERR_AJAX_LOAD'     => '一个错误已经发生:',
    'ERR_AJAX_LOAD_FAILURE'     => '处理您的请求时发生错误请稍后再试.',
    'ERR_AJAX_LOAD_FOOTER' => '如果错误依然存在请管理员禁用此模块',
    ...
    'LBL_LOCALE_NAME_EXAMPLE_TITLE' => '货币代码',
  ...
  'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => '没有可更新的操作',
    ...
    'LBL_FULL_FORM_BUTTON_LABEL' => '全屏显示',
    'LBL_FULL_FORM_BUTTON_TITLE' => '全屏显示 [Alt+F]',
    ...
    'LBL_SEARCH' => '查找',
    'LBL_SEARCH_TIPS' => '单击搜索按钮或按回车键，以对它们进行精确匹配。',
    ...
    'LBL_ACCESSKEY_SELECT_FILE_TITLE' => '选择文件夹[Alt+F]',
    'LBL_ACCESSKEY_SELECT_FILE_LABEL' => '选择文件夹',
    ...
    'LBL_ACCESSKEY_SELECT_USERS_TITLE' => '选择用户[Alt+U]',
    ...
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE' => '选择账户[Alt+A]',
    ...
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_TITLE' => '选择 市场活动 [Alt+M]',
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_LABEL' => '选择 市场活动',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_TITLE' => '清除 市场活动',
    'LBL_ACCESSKEY_CLEAR_CAMPAIGNS_LABEL' => '清除 市场活动',
    'LBL_ACCESSKEY_SELECT_CONTACTS_KEY' => 'C',
    'LBL_ACCESSKEY_SELECT_CONTACTS_TITLE' => '选择联系人[Alt+C]',
    ...
    'LBL_ACCESSKEY_SELECT_TEAMSET_TITLE' => '选择团队[Alt+Z]',
    ...
    'LBL_SERVER_MEMORY_LOG_MESSAGE' => '使用: - 模块: {0} - action: {1}',
    ...
    'LBL_SUGAR_COPYRIGHT' => '&copy; 2004-2012 SugarCRM 公司. 该软件在当前情况下，没有警示。  授权许可<a href="LICENSE.txt" target="_blank" class="copyRightLink">AGPLv3</a>.<br />保留所有权利',



    // The following version of LBL_SUGAR_COPYRIGHT is for Professional and Enterprise editions.

    'LBL_SUGAR_COPYRIGHT_SUB' => '&copy; 2004-2012 <a href="http://www.sugarcrm.com" target="_blank" class="copyRightLink">SugarCRM Inc.</a>保留所有权利。',
	...
	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\n点击确定来查看会议或点击取消来放弃查看消息",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "找不到结果。",
	'MSG_LIST_VIEW_NO_RESULTS' => "找不到结果： <item1>",
 	'MSG_LIST_VIEW_NO_RESULTS_SUBMSG' => "创建 <item1> 作为一个新的 <item2>",
	'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => "你现在还没有保存任何记录。 ",
	'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' =>	" 使用主导航上的用户下拉菜单获取帮助。",
    ...
    'LBL_SEARCH_RESULTS_FOUND' => '搜索到的结果',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => '欢迎来到Sugar门户 6.5.2',
  ...
  'LBL_NONE' => '-none-',
    ...
    'ERR_GOOGLE_API_415' => 'Google文件不支持您提供的文件格式',

    'LBL_EMPTY' => '空',
    'LBL_IS_EMPTY' => '是空的',
    'LBL_IS_NOT_EMPTY' => '不是空的',
    //IMPORT SAMPLE TEXT
...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_EXPORT_ASSIGNED_USER_ID' => '分配到',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '指定用户',
    'LBL_EXPORT_REPORTS_TO_ID' => '报告',
    'LBL_EXPORT_FULL_NAME' => '全名',
    'LBL_EXPORT_TEAM_ID' => '团队ID',
    'LBL_EXPORT_TEAM_NAME' => '团队',
    'LBL_EXPORT_TEAM_SET_ID' => '团队设立ID',

    'LBL_QUICKEDIT_NODEFS_NAVIGATION'=> '运行中... ',

    'LBL_PENDING_NOTIFICATIONS' => '通知',
    'LBL_ALT_ADD_TEAM_ROW' => '添加新的团队',
    'LBL_ALT_REMOVE_TEAM_ROW' => '删除团队',
    'LBL_ALT_SPOT_SEARCH' => '停止搜索',
    'LBL_ALT_SORT_DESC' => '降序',
    'LBL_ALT_SORT_ASC' => '升序',
    'LBL_ALT_SORT' => '类型',
    'LBL_ALT_SHOW_OPTIONS' => '显示选项',
    'LBL_ALT_HIDE_OPTIONS' => '隐藏选项',
    'LBL_ALT_MOVE_COLUMN_LEFT' => '移动所选入左侧列表',
    'LBL_ALT_MOVE_COLUMN_RIGHT' => '移动所选入右侧列表',
    'LBL_ALT_MOVE_COLUMN_UP' =>'将选定的项顺序排列',
    'LBL_ALT_MOVE_COLUMN_DOWN' => '将所选定的项倒序排列',
    'LBL_ALT_INFO' => '信息',
    ...
    'LBL_EMAIL_OPT_TITLE' => '选择电子邮件地址',
    'LBL_EMAIL_INV_TITLE' => '无效的电子邮件地址',
    'LBL_EMAIL_PRIM_TITLE' => '主要电子邮件地址',
    'LBL_SELECT_ALL_TITLE' => '全选',
    'LBL_SELECT_THIS_ROW_TITLE' => '选择这行',
    'LBL_TEAM_SELECTED_TITLE' => '团队选择 ',
    'LBL_TEAM_SELECT_AS_PRIM_TITLE' => '选择此团队为主要团队',

    //for upload errors
    'UPLOAD_ERROR_TEXT'          => '错误: 上传期间发生一个错误。错误代码: {0} - {1}',
    'UPLOAD_ERROR_TEXT_SIZEINFO' => '错误: 上传期间发生一个错误。错误代码: {0} - {1}。上传的最大值为 {2} ',
    'UPLOAD_ERROR_HOME_TEXT'     => '错误: 上传期间发生一个错误，请联系管理员获得相关帮助。',
    ...
    'LBL_KEYBOARD_SHORTCUTS_HELP_TITLE' => '快捷键',
